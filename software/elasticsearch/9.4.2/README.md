...
多节点 Elasticsearch 集群 + 1 个 Kibana，镜像为 `blankhang/elasticsearch:9.4.2`（含 IK）与官方 `kibana:9.4.2`。
...
- 已构建/拉取 `blankhang/elasticsearch:9.4.2`。
