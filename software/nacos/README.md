...
# 或
docker-compose -f /docker/nacos/redis-stack.yml up -d

# 重启
docker-compose -f /docker/nacos/redis-stack.yml restart

# 停止
docker-compose -f /docker/nacos/redis-stack.yml down
```