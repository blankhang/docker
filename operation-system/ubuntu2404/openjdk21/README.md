...
# blankhang/ubuntu2404:openjdk21
# docker会自动根据当前运行的架构拉取对应的镜像
# AMD架构 执行 docker pull blankhang/ubuntu2404:openjdk21 ----> blankhang/ubuntu2404:openjdk21-amd64
# ARM64V8架构 执行 docker pull blankhang/ubuntu2404:openjdk21 ----> blankhang/ubuntu2404:openjdk21-arm64v8
