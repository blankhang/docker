...
# blankhang/ubuntu2404:openjdk17
# docker会自动根据当前运行的架构拉取对应的镜像
# AMD架构 执行 docker pull blankhang/ubuntu2404:openjdk17 ----> blankhang/ubuntu2404:openjdk17-amd64
# ARM64V8架构 执行 docker pull blankhang/ubuntu2404:openjdk17 ----> blankhang/ubuntu2404:openjdk17-arm64v8
