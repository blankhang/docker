...
# blankhang/ubuntu2404:openjdk11
# docker会自动根据当前运行的架构拉取对应的镜像
# AMD架构 执行 docker pull blankhang/ubuntu2404:openjdk11 ----> blankhang/ubuntu2404:openjdk11-amd64
# ARM64V8架构 执行 docker pull blankhang/ubuntu2404:openjdk11 ----> blankhang/ubuntu2404:openjdk11-arm64v8
